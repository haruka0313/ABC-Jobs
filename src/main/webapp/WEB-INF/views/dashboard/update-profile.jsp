...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <div class="container">
        <form:form modelAttribute="profile" action="update-profile" method="post">
            <div class="row border rounded-3 p-3 mb-4" style="margin-top:50px; margin-bottom:40px;">
              <div class="rounded-circle bg-primary bg-gradient d-flex align-items-center justify-content-center text-white" style="width: 100px; height: 100px;">
                    <span>${f}</span>
                    <span>${l}</span>
                </div>
                <div class="col-8">
